...
const shots = [
  { src: couple1, span: "md:col-span-2 md:row-span-2", depth: -40, caption: "Buổi sáng đầu tiên" },
  { src: couple2, span: "", depth: 30, caption: "Nắng cuối thu" },
  { src: ringsImg, span: "", depth: -20, caption: "Lời hẹn ước" },
  { src: couple3, span: "md:col-span-2", depth: 50, caption: "Trên những con đường" },
  { src: coupleProposal, span: "md:row-span-2", depth: -30, caption: "Đêm cầu hôn" },
  { src: venueImg, span: "", depth: 20, caption: "Nơi chúng ta gặp lại" },
];
    ...
    <section id="gallery" className="relative py-24 sm:py-32 px-4 overflow-hidden">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-medium mt-3 text-foreground">
          Khoảnh khắc <span className="italic" style={{ color: accentColor }}>không thể quên</span>
        </h2>
        <p className="text-muted-foreground font-body mt-4 max-w-xl mx-auto">
          Bộ sưu tập biên tập như một tờ tạp chí — mỗi khung hình là một chương riêng.
        </p>
      </div>
