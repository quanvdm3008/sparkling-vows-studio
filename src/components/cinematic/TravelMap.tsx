...
const stops = [
  { icon: Plane, label: "Sân bay Tân Sơn Nhất", time: "~25 phút" },
  { icon: Car, label: "Quận 1 — trung tâm", time: "~10 phút" },
  { icon: Navigation, label: "Đỗ xe miễn phí", time: "Tầng B1" },
  { icon: Compass, label: "Lối vào sảnh chính", time: "Cổng số 2" },
];
    ...
    <section id="travel" className="relative py-24 sm:py-32 px-4 overflow-hidden">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-medium mt-3 text-foreground">
          Đường đến <span className="italic" style={{ color: accentColor }}>tình yêu</span>
        </h2>
        <p className="text-muted-foreground font-body mt-4">
          Một hành trình ngắn — nhưng đáng nhớ. Hãy đến đúng giờ nhé.
        </p>
      </div>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                <p className="text-xs tracking-[0.3em] uppercase font-body text-white/70">Địa điểm tổ chức</p>
