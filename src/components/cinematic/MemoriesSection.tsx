...
const milestones = [
  ...
  { icon: Plane, label: "Chuyến đi đầu tiên", date: "06/2020" },
  { icon: Heart, label: "Nói lời yêu", date: "02/2021" },
  { icon: Camera, label: "Bộ ảnh đầu tiên", date: "12/2022" },
    ...
    <section id="memories" className="relative py-24 sm:py-32 px-4 overflow-hidden">
      <div className="max-w-3xl mx-auto text-center mb-14">
        ...
        <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-medium mt-3 text-foreground">
          Những điều <span className="italic" style={{ color: accentColor }}>không thể quên</span>
        </h2>
      </div>
