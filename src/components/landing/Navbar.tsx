    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href="#templates" className="font-body text-sm font-semibold text-foreground/80 hover:text-foreground">
            Đăng nhập
          </a>
          <a
            href="#templates"
          ...
          >
            {links.map((l) => (
              <a
                ...
                className="font-body text-base text-foreground/80 py-1.5"
              >
                {l.label}
              </a>
            ))}
